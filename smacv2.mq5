...
void EvaluateTradeSignal(int current_bar_i, datetime t, double live_price, int trigger_dir, double p_pct, bool is_strong, double minor_extreme_sl, int maj_extreme_i, bool is_test = false)
  {
   ...
   // Destekleyici yapilar ve MTF CHoCH algoritmasi kullanicinin istegi uzerine tamamen kaldirilmistir.
   // Puan hesabi yalnizca Yukaridaki Momentum MTF (Test Kismi) matrixi tarafindan yapilmaktadir.
