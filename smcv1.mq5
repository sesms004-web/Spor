      ...
      if (should_eval_bear && t2_valid) {
          ...
          if (draw_ui && (!is_history || (InpWaitRetest && is_just_closed))) {
              ...
              if (state.d1_i != last_alert_d1_i_bear) {
                  bool is_first_trade = (last_alert_maj_i_bear != state.maj_h_i);
                  bool is_second_trade = (!is_first_trade && state.t2_h > state.t1_h);
      ...
      if (should_eval_bull && t2_valid) {
          ...
          if (draw_ui && (!is_history || (InpWaitRetest && is_just_closed))) {
              ...
              if (state.d1_i != last_alert_d1_i_bull) {
                  bool is_first_trade = (last_alert_maj_i_bull != state.maj_l_i);
                  bool is_second_trade = (!is_first_trade && state.t2_l < state.t1_l);
