...
void DrawMTFPanel()
{
   ...
   string gv_top="SMACv2_bx_top", gv_bot="SMACv2_bx_bot";
   string gv_wkt="SMACv2_wk_top", gv_wkb="SMACv2_wk_bot";
   ...
   for(int i=0;i<7;i++)
   {
      ...
      // Son 3 kapanmış bar al
      if(CopyRates(Symbol(),tfs[i].tf,1,3,r)<3)
      {
      ...
      bool above   = (l>bx_top);   // kutunun üstünde
      bool below   = (h<bx_bot);   // kutunun altında
